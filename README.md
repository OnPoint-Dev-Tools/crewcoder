...
- **Modes.** `general` (default coding), `crewcoder` (deliberate clarify, plan, approve, and implement workflow), `plugin` (CrewCode app plugin architect), `extension` (CrewCoder extension architect). See [CREWCODER_MODE.md](https://github.com/OnPoint-Dev-Tools/crewcoder/blob/main/crewcoder-agent/docs/CREWCODER_MODE.md) and [EXTENSION_MODE.md](https://github.com/OnPoint-Dev-Tools/crewcoder/blob/main/crewcoder-agent/docs/EXTENSION_MODE.md).
